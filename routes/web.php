...
//doctor on set
Route::get('getactive', 'AppointmentController@seat');

//aprove appointment
Route::post('approve/{id}', 'ApprovedController@approve');



//fetch from user table
Route::get('api/user/all', 'AdminController@allAppointment');
Route::delete('api/appointments/{id}', 'AdminController@destroy');
...
Route::get('/add-post','PatientController@addPost');
